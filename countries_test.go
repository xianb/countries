...
func TestRegionsString(t *testing.T) {
	for _, c := range AllRegions() {
		...
		if c.StringCn() == "" || c.StringCn() == UnknownMsg {
			t.Errorf("Test RegionCode.StringCn() err")
		}
	}
	...
	if unknown.StringCn() != UnknownMsg {
		t.Errorf("Test RegionCode.StringCn() err")
	}
	if RegionNone.String() == "" || RegionNone.String() == UnknownMsg {
		t.Errorf("Test RegionCode.String() err")
	}
	if RegionNone.StringCn() == "" || RegionNone.StringCn() == UnknownMsg {
		t.Errorf("Test RegionCode.StringCn() err")
	}
}
...
func TestCountriesString(t *testing.T) {
	for _, c := range getAllCountries(t) {
		...
		if (c.StringCn() == "" || c.StringCn() == UnknownMsg) && c != Unknown {
			t.Errorf("Test All.StringCn() err")
		}
	}
}
